...
<%
    ...
    Perfil perfil = dao.buscarPorId(id);
%>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <div class="form-container">
        ...
        <form action="ControladorPerfil" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" name="perfil" value="<%= perfil.getPerfil() %>" required>
            </div>
            
            <button type="submit" class="btn-submit">Actualizar Perfil</button>
            <button type="button" onclick="window.location.href='ControladorPerfil?accion=listar'" class="btn-volver">← Volver</button>
        </form>
    </div>
</body>
</html>